...
public class NetworkedPrefab
{
    ...
    {
        int extensionPath = System.IO.Path.GetExtension(path).Length;
        ...
        {
            return path.Substring(startIndex + additionalLenght, path.Length - (additionalLenght + startIndex + extensionPath));
        }
