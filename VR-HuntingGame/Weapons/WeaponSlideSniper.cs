...
namespace BNG {
    ...
    /// </summary>
    public class WeaponSlideSniper : MonoBehaviour {
        ...
        float initialMass;
        [Header("SOUND")]
        [Tooltip("Silah ses ayari")]
        public float slideBackSoundStart = 0.01f;
        public float slideBackSoundEnd = 0.9f;
        public float slideBackSoundVolume = 0.9f;

        public float slideForwardSoundStart = 0.9f;
        public float slideForwardSoundEnd = 1.5f;
        public float slideForwardSoundVolume = 0.9f;
        ...
        void onSlideBack()
        {
            if (thisGrabbable.BeingHeld || parentGrabbable.BeingHeld)
            {
                playSoundInterval(slideBackSoundStart, slideBackSoundEnd, slideBackSoundVolume);
            }
        ...
        void onSlideForward()
        {
            if (thisGrabbable.BeingHeld || parentGrabbable.BeingHeld)
            {
                playSoundInterval(slideForwardSoundStart, slideForwardSoundEnd, slideForwardSoundVolume);
            }
